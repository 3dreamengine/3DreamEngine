...
function sh:constructDefinesGlobal(dream, info)
	return [[
		...
		float sampleShadowSunSmooth(vec3 vertexPos, mat4 transformProjShadow_1, mat4 transformProjShadow_2, mat4 transformProjShadow_3, sampler2DShadow tex_shadow_1, sampler2DShadow tex_shadow_2, sampler2DShadow tex_shadow_3) {
			float bias = 0.00075;
...
function sh:constructPixel(dream, info, ID)
	return ([[
		float shadow;
		if (smooth_#ID#) {
			shadow = sampleShadowSunSmooth(vertexPos, transformProjShadow_1_#ID#, transformProjShadow_2_#ID#, transformProjShadow_3_#ID#, tex_shadow_1_#ID#, tex_shadow_2_#ID#, tex_shadow_3_#ID#);
		} else {
			shadow = sampleShadowSun(vertexPos, transformProjShadow_1_#ID#, transformProjShadow_2_#ID#, transformProjShadow_3_#ID#, tex_shadow_1_#ID#, tex_shadow_2_#ID#, tex_shadow_3_#ID#);
		}
		if (shadow > 0.0) {
